...
const sessions = [
  { child: "Amaury T.", episode: "Morning Routine", duration: "5m 12s", pattern: "Fronting", date: "Feb 9, 2026" },
  { child: "Léa M.", episode: "Animal Friends", duration: "3m 45s", pattern: "Deletion", date: "Feb 9, 2026" },
  { child: "Noah B.", episode: "Color World", duration: "4m 08s", pattern: "Gliding", date: "Feb 8, 2026" },
  { child: "Chloé R.", episode: "Food Fun", duration: "6m 21s", pattern: "Stopping", date: "Feb 8, 2026" },
  { child: "Lucas D.", episode: "Bath Time", duration: "4m 55s", pattern: "Fronting", date: "Feb 7, 2026" },
];
        ...
        <tbody>
          {sessions.map((s, i) => (
            <tr key={i} className="border-b border-border last:border-0 hover:bg-muted/50">
              ...
              <td className="px-5 py-3"><button className="text-xs font-medium text-primary hover:underline">{t("view")}</button></td>
            </tr>
          ))}
        </tbody>
      </table>
